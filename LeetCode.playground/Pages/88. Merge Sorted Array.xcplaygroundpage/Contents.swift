 ...
 **Explanation:** The arrays we are merging are [] and [1].\
 The result of the merge is [1].\
 Note that because m = 0, there are no elements in nums1. The o is
 only there to ensure the merge result can fit in numsl.
 ...
 **Constraints:**
 ...
 Follow up: Can you come up with an algorithm that runs in (0(m + n) time?
